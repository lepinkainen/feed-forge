...
func TestCreateGenericFeedData_Reddit(t *testing.T) {
	...
	if item.AuthorURI != "https://www.reddit.com/user/testuser" {
		t.Errorf("Expected AuthorURI 'https://www.reddit.com/user/testuser', got '%s'", item.AuthorURI)
	}
}
...
func TestCreateGenericFeedData_HackerNews(t *testing.T) {
	...
	if item.AuthorURI != "https://news.ycombinator.com/user?id=testuser" {
		t.Errorf("Expected AuthorURI 'https://news.ycombinator.com/user?id=testuser', got '%s'", item.AuthorURI)
	}
}
